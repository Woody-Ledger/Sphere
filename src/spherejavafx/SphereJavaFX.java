...
public class SphereJavaFX extends Application {
    ...
    public void start(Stage primaryStage) {
       ...
       System.out.println("choose a photo to be used (1, 2 or 3)");

       int photo = input.nextInt();
       
       System.out.println("How big do you want it to be? (between 1 - 10)");
       
       int x = input.nextInt();
       
       System.out.println("How fast do you want it to spin? (between 0 - 10)");
       ...
       int y = input.nextInt();
        ...
        Sphere mysphere = new Sphere(20 * x);
        ...
        if(photo == 2){
        Image earthImage = new Image("file:pokeball.jpg");
        PhongMaterial earthPhong = new PhongMaterial();
        earthPhong.setDiffuseMap(earthImage);
        mysphere.setMaterial(earthPhong);
        }
        if(photo == 3){
        Image earthImage = new Image("file:waves.jpg");
        PhongMaterial earthPhong = new PhongMaterial();
        earthPhong.setDiffuseMap(earthImage);
        mysphere.setMaterial(earthPhong);
        }
